            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                <Typography className={classes.article}>
                  ...
                  his is my portfolio website. After I started creating it I
                ...
                <Typography className={classes.article}>
                  ...
                  for a job, there would be fierce competition. As it is better
                ...
                <Typography className={classes.article}>
                  ...
                  brand to its truest form and from there I started
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                <Typography className={classes.article}>
                  ...
                  intending to perpetuate a major challenge: bringing 1400
                ...
                <Typography className={classes.article}>
                  ...
                  merchandising. My most relevant work will be presented below.
                </Typography>
                <Typography className={classes.articleTitle}>
                  #01 - THE LOGO
                </Typography>
                ...
                />
                <Typography className={classes.article}>
                  Traditionally, the logo contains 3 summits embedded in it.
                  With this constraint in mind, I first started to work on the
                ...
                <Typography className={classes.article}>
                  ...
                  sign. I choose the negative technique to make it discreet but
                  still noticeable.
                </Typography>
                <Typography className={classes.articleTitle}>
                  #02 - COLORS
                ...
                <Typography className={classes.article}>
                  I jumped into it headfirst, experimenting a lot. After long
                  hours, I was proud of the result.
                </Typography>
                <Typography className={classes.article}>
                  The length of the video was reduced by 20% from the precedent
                ...
                <Typography className={classes.article}>
                  Each participant receives a bag full of personalized objects
                  such as:
                  <ul>
                    <li>Sweatshirt</li>
                    <li>Card deck</li>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                <Typography className={classes.article}>
                  ...
                  Hackathon. Considered as the outsiders (no developer in the
                ...
                <Typography className={classes.article}>
                  ...
                  can reduce people's ecological footprint with the help of open
                  banking standards. At the Fintechlab Hackathon taking place
                  ...
                  effectively reduce the negative impact on the environment. The
                ...
                <Typography className={classes.article}>
                  We assumed that many people want to be part of the ecological
                  transition but lack an easy and intuitive tool to do so. We
                  believe that such a tool could effectively raise awareness and
                  change users’ consumption habits. We thought about using the
                  digital transition of banks as a lever, making the best out of
                  open banking, to link management of ﬁnances and ecological
                  impact.
                </Typography>
                <Typography className={classes.article}>
                  From this point on, a PFM-like (Personal Finance Management)
                  solution came quite naturally. One that would be convenient to
                  use regularly but filled with the right data to guide the user
                ...
                <Typography className={classes.article}>
                  ...
                  and run one. More personally, I saw an opportunity to learn to
                  code and seized it.
                </Typography>
                <Typography className={classes.article}>
                  We had our MVP about 3 months after and kept making iterations
                  on its design and functionalities. You can visit the website{" "}
                  <a
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                <Typography className={classes.article}>
                  ...
                  Olympics and additionally, to bring the flame symbol into the
                ...
                <Typography className={classes.article}>
                  As stated above, the colors were extracted from the
                  traditional Olympics colors.
                </Typography>
                <Typography className={classes.article}>
                ...
                <Typography className={classes.article}>
                  ...
                  know ?" was our most successful campaign as we shared fun
                  facts about each campus, raising the engagement level as well
                  as the competitiveness between campuses. It also served as an
                ...
                <Typography className={classes.article}>
                  Here is an example of what the T-shirt logos looked like for
                  each campus:
                </Typography>
                <img
                  src={
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                <Typography className={classes.article}>
                  ...
                  popular that I could not stay away from them for too long. As
                  I am soon going to be a mechanical engineer, I took on the
                ...
                <Typography className={classes.article}>
                  Before starting to dig into the math, it is important to make
                ...
                <Typography className={classes.article}>
                  <ul>
                    ...
                    <li>The structure is perfectly symmetrical</li>
                ...
                <Typography className={classes.article}>
                  ...
                  />{" "}
                  a constant that links the motor rotational speed to the force
                  ...
                  />
                  , a constant that links the the motor rotational speed to the
                  torque it generates.
                </Typography>
                <Typography className={classes.article}>
                ...
                <Typography className={classes.article}>
                  We want our drone to automatically update the speed of the
                  motors to stay stabilized. To do so, I implemented a PID
                ...
                <Typography className={classes.article}>
                  From here on, I implemented these equations into a python
                  script to simulate the response of the system.
                </Typography>
                <Typography className={classes.article}>
                  I imagined a scenario where the drone would be 10m high with a
                  10° offset in each of the rotational axes. Here are the
                ...
                <Typography className={classes.article}>
                  The equations seem to be working properly, but the real
